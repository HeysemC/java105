...
public class C08_MDA_Soru {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length; i++) {//outer array icindeki inner array'deki kontrol eder
            innerArrToplami=0;
            for (int j = 0; j < arr[i].length; j++) {//her bir inner array'in tum elementlerini kontrol eder
