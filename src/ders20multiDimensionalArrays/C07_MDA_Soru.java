...
public class C07_MDA_Soru {
    public static void main(String[] args) {
        ...
        //inner 2 array olacagini ama bunlari uzunluklarinin degisebilecegini kabul ettik

        int ortakIndexSayiyi = arr[0].length<arr[1].length ? arr[0].length : arr[1].length;

       int[] ortakIndexToplamlariArr=new int[ortakIndexSayiyi];
