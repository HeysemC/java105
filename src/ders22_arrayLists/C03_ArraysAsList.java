...
public class C03_ArraysAsList {
    public static void main(String[] args) {
        ...
        1-bu sekide olusturulan list'ler esnek uzunluga sahip degillerdir
          add,remove gibi ozellileri kullanmak istersek RunTimeException olusur
        arraydenList.add(10);UnsupportedOperationException desteklenmeyen operasyon
        ...
        //sadece array'in bir elemanini degisterelim
        arr[0]=10;

        System.out.println("array'yi");
    }
}
/*
  Integer[] arr = {1,2,3};
