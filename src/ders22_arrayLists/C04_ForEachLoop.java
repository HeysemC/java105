...
public class C04_ForEachLoop {
    public static void main(String[] args) {
        ...
        //bu array'deki 5'ten buyuk olan tum elementleri toplayalim
        int toplam=0;
        ...
        /*for-each loop daha basit bir kurgu ile calisir
          for-each loop'a 3 seyi soylememiz lazim
           1-hangi dat turunde degiskenlerle ugrasacaksaniz
           2-loop'un icersinde herbir eleman geldiginde hangi isimle geldigi
         */
